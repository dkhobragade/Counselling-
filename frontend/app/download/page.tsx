...
import { faLightbulb, faPenFancy, faEye, faKey, faFileAlt, faBookOpen, faSearch, faDownload, faFileArchive, faFileDownload, faInfoCircle } from '@fortawesome/free-solid-svg-icons'
