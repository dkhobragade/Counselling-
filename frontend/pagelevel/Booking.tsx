...
import { timeSlots } from '@/helper/Constant'
                        ...
                        <div className="p-6">
                            ...
                            <div className="mt-6">
                                <button
                                    ...
                                    className={ `w-full py-3 font-semibold rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors ${ !selectedPackage || !selectedMentor || !selectedDate || !selectedTimeSlot ? "opacity-50 cursor-not-allowed" : "" } !rounded-button whitespace-nowrap cursor-pointer` }
                                    disabled={
                                        !selectedPackage ||
                                        !selectedMentor ||
                                        !selectedDate ||
